...
public class GrinderE extends GrinderEB {
    public GrinderE() {
        super(Core.GrinderE, Core.GrinderR);
    }

    protected Text getContainerName() {
        return new TranslatableText("block.tofurtherworld.grinder_t");
    }
...
abstract class GrinderEB extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    private static final int[] TOP_SLOTS = new int[]{0,3};
    private static final int[] BOTTOM_SLOTS = new int[]{2, 1,4};
    private static final int[] SIDE_SLOTS = new int[]{1,4};
    ...
    protected final RecipeType<? extends GrinderR> recipeType;

    protected GrinderEB(BlockEntityType<?> blockEntityType, RecipeType<? extends GrinderR> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return GrinderEB.this.burnTime;
                    case 1:
                        return GrinderEB.this.fuelTime;
                    case 2:
                        return GrinderEB.this.cookTime;
                    case 3:
                        return GrinderEB.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        GrinderEB.this.burnTime = value;
                        break;
                    case 1:
                        GrinderEB.this.fuelTime = value;
                        break;
                    case 2:
                        GrinderEB.this.cookTime = value;
                        break;
                    case 3:
                        GrinderEB.this.cookTimeTotal = value;
                }
    ...
    public void tick() {
        ...
        if (!this.world.isClient) {
            ...
            if (!this.isBurning() && (itemStack.isEmpty() || ((ItemStack)this.inventory.get(0)).isEmpty())&&((ItemStack)this.inventory.get(3)).isEmpty()) {
    ...
    protected boolean canAcceptRecipeOutput( Recipe<?> recipe) {
        if ((!((ItemStack)this.inventory.get(0)).isEmpty()||!((ItemStack)this.inventory.get(3)).isEmpty()) && recipe != null) {
    ...
    protected int getCookTime() {
        return (Integer)this.world.getRecipeManager().getFirstMatch(this.recipeType, this, this.world).map(GrinderR::getCookTime).orElse(200);
    }
...
}/*extends LootableContainerBlockEntity implements Tickable, RecipeInputProvider {
