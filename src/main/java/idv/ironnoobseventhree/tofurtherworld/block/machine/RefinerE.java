...
public class RefinerE extends RefinerEB {
    ...
    public RefinerE() {
        super(RefinerE, RecipeType.SMELTING);
    }

    protected Text getContainerName() {
        return new TranslatableText("block.tofurtherworld.refiner_t");
    }

    protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return new RefinerSH(syncId, playerInventory, this, this.propertyDelegate);
    }
}
abstract class RefinerEB extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected RefinerEB(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipe> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return RefinerEB.this.burnTime;
                    case 1:
                        return RefinerEB.this.fuelTime;
                    case 2:
                        return RefinerEB.this.cookTime;
                    case 3:
                        return RefinerEB.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        RefinerEB.this.burnTime = value;
                        break;
                    case 1:
                        RefinerEB.this.fuelTime = value;
                        break;
                    case 2:
                        RefinerEB.this.cookTime = value;
                        break;
                    case 3:
                        RefinerEB.this.cookTimeTotal = value;
                }
