...
public class OldAgeGen extends ChunkGenerator{
    protected final boolean customBool;

    public static final Codec<OldAgeGen> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                    ...
                    .apply(instance, instance.stable(OldAgeGen::new))
    );

    public OldAgeGen(BiomeSource biomeSource, boolean customBool) {
