...
public abstract class GrinderRB implements Recipe<Inventory> {
    ...
    public GrinderRB(RecipeType<?> type, Identifier id, String group, Ingredient input1, Ingredient input2, ItemStack output, float experience, int cookTime) {
        this.type = type;
        this.id = id;
        this.group = group;
        this.input1 = input1;
