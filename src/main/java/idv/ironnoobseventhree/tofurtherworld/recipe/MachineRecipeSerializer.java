...
public class MachineRecipeSerializer<T extends RefinerRB> implements RecipeSerializer<T> {
    public final int cookingTime;
    public final MachineRecipeSerializer.RecipeFactory<T> recipeFactory;

    public MachineRecipeSerializer(MachineRecipeSerializer.RecipeFactory<T> recipeFactory, int cookingTime) {
