...
public class RefinerRS implements RecipeSerializer<RefinerR> {
    private final int cookingTime;
    private final RecipeFactory<RefinerR> recipeFactory;

    public RefinerRS(RecipeFactory<RefinerR> recipeFactory, int cookingTime) {
        this.cookingTime = cookingTime;
        this.recipeFactory = recipeFactory;
    }

    public RefinerR read(Identifier identifier, JsonObject jsonObject) {
    ...
    public RefinerR read(Identifier identifier, PacketByteBuf packetByteBuf) {
    ...
    public void write(PacketByteBuf packetByteBuf, RefinerR abstractCookingRecipe) {
    ...
    public interface RecipeFactory<T extends RefinerRB> {
